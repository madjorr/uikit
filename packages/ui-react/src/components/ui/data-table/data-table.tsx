...
// column visibility, row selection, pagination, and optional row expansion. It
// adds no color of its own beyond the shared `border-border` wrapper; every
// styled part (header menu, pagination, toolbar) is a themed ui-react component.
...
// the cell borders (`--ui-table-global-cell-border-color`) and the empty-state
// uses the muted table-value color (`--ui-table-data-value-color-disabled`).
