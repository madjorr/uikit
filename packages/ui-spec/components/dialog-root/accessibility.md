# DialogRoot — accessibility

DialogRoot leans on the Base UI Dialog primitive for its modal semantics,
focus management, and keyboard handling. The author's job is to provide an
accessible name and description and to use the parts as intended.
